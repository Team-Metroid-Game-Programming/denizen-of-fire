...
// Many much credit to Jellybit
// From Jellybit: https://gist.github.com/Jellybit/9f6182c25bceac06db31
...
public class CameraControl : MonoBehaviour {
	...
	public bool showDebugBoxes = true; // delta de false
	...
	void CameraUpdate ()
	{
		...
		else // I added this to try to keep the camera from dropping tl
			 // Plot twist the camera was falling because I gave it a rigid body with a gravity scale, fixed that tl
		{
			cameraPosition = transform.position;
			if (!windowRect.Contains(playerPosition))
			{
